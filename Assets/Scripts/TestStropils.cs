...
public class TestStropils : MonoBehaviour
{
    ...
    {
        for (int i = 0; i < GameObjectsStropils[counter].transform.GetChild(0).childCount; i++)
        {
            GameObjectsStropils[counter].transform.GetChild(0).GetChild(i).gameObject.SetActive(true);
        }
